  ...
  if (!optimization) {
    return (
      <div className="text-center py-24">
        ...
        <p className="text-slate-500 mb-6">Please import a dataset to run budget optimization.</p>
        <button 
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Budget Optimizer</h1>
          <p className="text-slate-500 mt-1">Simulate budget allocation scenarios across your marketing mix to forecast ROI impact.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
        ...
        <div className="lg:col-span-1 h-full">
            <BudgetSimulationSidebar 
                ...
                onWeightChange={(ch, val) => setChannelWeights(prev => ({ ...prev, [ch]: val }))}
                onReset={() => {
